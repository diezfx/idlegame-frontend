...
export const file_v1_masterdata: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_duration]);
...
export type ItemStats = Message<"v1.ItemStats"> & {
  ...
  /**
   * @generated from field: int32 inventory_size = 3;
   */
...
/**
 * @generated from message v1.LocationDefinition
 */
export type LocationDefinition = Message<"v1.LocationDefinition"> & {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
  ...
  /**
   * @generated from field: v1.LocationType type = 4;
   */
  type: LocationType;

  /**
   * @generated from field: repeated v1.WorkStationDefinition workstations = 5;
   */
  workstations: WorkStationDefinition[];

  /**
   * @generated from field: repeated string gathering_job_definition_ids = 6;
   */
  gatheringJobDefinitionIds: string[];

  /**
   * @generated from field: repeated string battle_job_definition_ids = 7;
   */
  battleJobDefinitionIds: string[];
};

/**
 * Describes the message v1.LocationDefinition.
 * Use `create(LocationDefinitionSchema)` to create a new message.
 */
export const LocationDefinitionSchema: GenMessage<LocationDefinition> = /*@__PURE__*/
  messageDesc(file_v1_masterdata, 5);

/**
 * @generated from message v1.WorkStationDefinition
 */
export type WorkStationDefinition = Message<"v1.WorkStationDefinition"> & {
  /**
   * @generated from field: string id = 1;
   */
  id: string;
  ...
  /**
   * @generated from field: repeated v1.JobSubType supported_sub_types = 3;
   */
  supportedSubTypes: JobSubType[];
};

/**
 * Describes the message v1.WorkStationDefinition.
 * Use `create(WorkStationDefinitionSchema)` to create a new message.
 */
export const WorkStationDefinitionSchema: GenMessage<WorkStationDefinition> = /*@__PURE__*/
...
export type ProductionJobDefinition = Message<"v1.ProductionJobDefinition"> & {
   ...
   */
  rewards?: RewardDefinition | undefined;
...
export type Container = Message<"v1.Container"> & {
  ...
  /**
   * @generated from field: repeated v1.LocationDefinition locations = 6;
   */
...
export const TileSchema: GenMessage<Tile> = /*@__PURE__*/
  messageDesc(file_v1_masterdata, 15);
...
/**
 * @generated from enum v1.LocationType
 */
export enum LocationType {
  ...
  /**
   * @generated from enum value: LOCATION_TYPE_CITY = 1;
   */
  CITY = 1,

  /**
   * @generated from enum value: LOCATION_TYPE_OUTPOST = 2;
   */
  OUTPOST = 2,
}

/**
 * Describes the enum v1.LocationType.
 */
export const LocationTypeSchema: GenEnum<LocationType> = /*@__PURE__*/
  enumDesc(file_v1_masterdata, 4);
