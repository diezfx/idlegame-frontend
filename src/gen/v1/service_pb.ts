...
import type { EntityState, EntityStateSchema, Event, GameState, Item, Job, JobSchema, RouteManifest, TransportJob, TransportJobSchema } from "./domain_pb";
import { file_v1_domain } from "./domain_pb";
import type { BattleJobDefinition, ItemDefinition, LocationDefinition, MonsterDefinition, ProductionJobDefinition } from "./masterdata_pb";
...
export const file_v1_service: GenFile = /*@__PURE__*/
  fileDesc("", [file_buf_validate_validate, file_google_protobuf_duration, file_google_protobuf_empty, file_google_protobuf_timestamp, file_v1_domain, file_v1_masterdata, file_v1_views]);
...
export type GetInventoryResponse = Message<"v1.GetInventoryResponse"> & {
  /**
   * @generated from field: v1.InventoryView inventory = 1;
   */
...
export type ListMonstersResponse = Message<"v1.ListMonstersResponse"> & {
  /**
   * @generated from field: repeated v1.EntityState monsters = 1;
   */
...
/**
 * @generated from message v1.GetLocationsResponse
 */
export type GetLocationsResponse = Message<"v1.GetLocationsResponse"> & {
  /**
   * @generated from field: repeated v1.LocationDefinition locations = 1;
   */
  locations: LocationDefinition[];
};

/**
 * Describes the message v1.GetLocationsResponse.
...
export const MonsterService: GenService<{
  ...
  getMonster: {
    ...
    output: typeof EntityStateSchema;
  },
  /**
...
export const MasterdataService: GenService<{
  ...
  /**
   * @generated from rpc v1.MasterdataService.GetLocations
   */
  getLocations: {
    methodKind: "unary";
    input: typeof EmptySchema;
