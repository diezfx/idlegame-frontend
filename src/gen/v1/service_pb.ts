...
export const file_v1_service: GenFile =
	/*@__PURE__*/
	fileDesc(
		'',
		[file_google_protobuf_empty, file_v1_domain],
	);
 ...
 */
export const GetMonsterRequestSchema: GenMessage<GetMonsterRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 0);
 ...
 */
export const GetJobRequestSchema: GenMessage<GetJobRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 2);
 ...
 */
export const ListJobsResponseSchema: GenMessage<ListJobsResponse> = /*@__PURE__*/ messageDesc(file_v1_service, 3);
 ...
 */
export const DeleteJobRequestSchema: GenMessage<DeleteJobRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 4);
 ...
 */
export const StartBattleRequestSchema: GenMessage<StartBattleRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 5);
 ...
 */
export const EntityIdResponseSchema: GenMessage<EntityIdResponse> = /*@__PURE__*/ messageDesc(file_v1_service, 6);
 ...
 */
export const GetInventoryRequestSchema: GenMessage<GetInventoryRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 8);
 ...
 */
export const EquipmentSchema: GenMessage<Equipment> = /*@__PURE__*/ messageDesc(file_v1_service, 9);
 ...
 */
export const EquipItemRequestSchema: GenMessage<EquipItemRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 11);
 ...
 */
export const UnEquipItemRequestSchema: GenMessage<UnEquipItemRequest> = /*@__PURE__*/ messageDesc(file_v1_service, 12);
